...
def main():
    ...
    with open(root_dir.joinpath("_ark/dx/macros/dx_macros.dta"), "r", encoding="ISO-8859=1") as f:
    ...
    with open(root_dir.joinpath("_ark/dx/macros/dx_macros.dta"), "w", encoding="ISO-8859=1") as ff:
