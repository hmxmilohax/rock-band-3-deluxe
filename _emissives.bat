...
FOR /F "tokens=*" %%G IN ('dir /b *.png_xbox') DO python "%~dp0dependencies/swap_dds_bytes.py" "%~dp0_ark/ui/track/emissives/gen/%%G" "%~dp0_ark/ui/track/emissives/gen/%%~nG.png_ps3"