...
"%~dp0..\dependencies/sed.exe" -i -e "s/broken_glass//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/01_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/neg_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/02_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/flare_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/outer_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/style_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/fx_smasher_smoke_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
...
"%~dp0..\dependencies/sed.exe" -i -e "s/smasher_plate_bracket_//g" "%~dp0..\_ark\ui\track\smashers\smashers.dta"
