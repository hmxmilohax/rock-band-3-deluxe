...
FOR /F "tokens=*" %%G IN ('dir /b *.png') DO "%~dp0..\dependencies/superfreq.exe" png2tex "%~dp0..\custom_textures\custom_track_textures/%%G" "%~dp0..\_ark\track\custom_track_textures\gen\%%~nG.png_xbox" --platform x360 --miloVersion 26
