...
"%~dp0..\dependencies/sed.exe" -i -e "s/gem_cap_//g" "%~dp0..\_ark\ui\track\gems\gems.dta"
...
"%~dp0..\dependencies/sed.exe" -i -e "s/sparks_radial_//g" "%~dp0..\_ark\ui\track\gems\gems.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/sparks_//g" "%~dp0..\_ark\ui\track\gems\gems.dta"
"%~dp0..\dependencies/sed.exe" -i -e "s/vertical_//g" "%~dp0..\_ark\ui\track\gems\gems.dta"
