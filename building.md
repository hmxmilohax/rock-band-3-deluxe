...
![Python is installed](dependencies/media/pywinverify.webp)
...
![Python is installed](dependencies/media/pymacverify.webp)
...
>
5. Name your branch whatever you want. Change `Source` to `hmxmilohax/rock-band-3-deluxe` and the branch to `develop`.  
...
> [!TIP]
> If you're contributing to the project, make sure you clone the repository you forked instead.  
Simply change the URL the username to yours, i.e. `https://github.com/MyUsername/rock-band-3-deluxe`
 
> 
2. 

![Repo Folder](dependencies/media/building/repofolder.png)
...
# Building
> [!CAUTION]
> While you can build a Wii version, we only use it for [[debugging purposes]](#Setting-Up-Debug) nowadays and offer no support for casual Wii play.
...
4. It the `Paths` section, it's recommended to enable `Search Subfolders` to list extracted images.
...
![Repo Folder](dependencies/media/building/dolcrash.webp)
