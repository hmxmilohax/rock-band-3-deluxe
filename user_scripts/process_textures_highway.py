...
for highway in highway_dir.glob("*"):
    if highway.suffix == ".png" or highway.suffix == ".jpg" or highway.suffix == ".bmp":
        ...
        cmd_convert_png = f"dependencies\magick\magick.exe convert custom_textures\highways\{highway.name} -resize 256x512! -filter Box custom_textures\highways\{highway.stem}.png".split()
