...
# temporarily move PS3 files out of the ark to reduce overall size
for f in ark_dir.rglob("*_ps3"):
...
# move the PS3 files back
for g in root_dir.joinpath("_tmp").rglob("*_ps3"):
